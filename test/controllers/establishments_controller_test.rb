...
class EstablishmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create establishment" do
    assert_difference('Establishment.count') do
      post establishments_url, params: { establishment: { name: @establishment.name, password: @establishment.password } }
    end
  ...
  test "should update establishment" do
    patch establishment_url(@establishment), params: { establishment: { name: @establishment.name, password: @establishment.password } }
