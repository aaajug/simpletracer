class ManagersController < ApplicationController
  ...
  def findByMail
    ...
    if @info.empty? # email not found
      respond_to do | format |
        format.js { render 'emailLookupNotice' }
      end
    else
